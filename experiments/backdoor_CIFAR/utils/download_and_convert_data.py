...
_process_and_save_to_disk(trainset, n_users=1, file_format='hdf5', output='./data/train_data')

print('Processing test set...')
_process_and_save_to_disk(testset, n_users=1, file_format='hdf5', output='./data/test_data')