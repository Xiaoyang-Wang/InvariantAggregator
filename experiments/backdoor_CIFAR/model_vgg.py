...
class VGG(nn.Module):
    ...
    def __init__(self, vgg, num_class, topK_results=None):
        ...
        self.vgg.add_module('flatten', nn.Flatten(1))
        self.vgg.add_module('dropout_1', nn.Dropout())
        self.vgg.add_module('linear_1', nn.Linear(512, 512))
        self.vgg.add_module('relu_1', nn.ReLU(True))
        self.vgg.add_module('dropout_2', nn.Dropout())
        self.vgg.add_module('linear_2', nn.Linear(512, 512))
        self.vgg.add_module('relu_2', nn.ReLU(True))
        self.vgg.add_module('dropout_3', nn.Dropout())
        self.vgg.add_module('linear_3', nn.Linear(512, num_class))
    ...
    def inference(self, inputs):
        ...
        f1 = f1_score(targets.cpu(), T.argmax(output, dim=1).cpu(), average='micro')
